<template>
  ...
  <teleport to="body">
    <transition name="adm-confirm">
      <div v-if="confirmDialog.show" class="adm-confirm-overlay" @click.self="confirmDialog.show = false">
        <div class="adm-confirm">
          <div class="adm-confirm__icon">🗑️</div>
          <h3 class="adm-confirm__title">{{ confirmDialog.title }}</h3>
          <p class="adm-confirm__text">{{ confirmDialog.message }}</p>
          <div class="adm-confirm__actions">
            <button class="adm-confirm__btn adm-confirm__btn--cancel" @click="confirmDialog.show = false">
              Отмена
            </button>
            <button class="adm-confirm__btn adm-confirm__btn--delete" @click="confirmDialog.onConfirm(); confirmDialog.show = false">
              Удалить
            </button>
          </div>
        </div>
...
.adm-confirm__btn--cancel {
  background: rgba(255,255,255,0.08);
  color: rgba(255,255,255,0.7);
}

.adm-confirm__btn--delete {
  background: #e53e3e;
  color: #fff;
}
